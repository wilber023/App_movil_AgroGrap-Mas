...
class TreatmentModel extends TreatmentEntity {
  const TreatmentModel({
    ...
    super.llmDiagnostico,
    super.llmTratamiento,
    super.llmPrevencion,
  ...
  factory TreatmentModel.fromJson(Map<String, dynamic> json) {
    return TreatmentModel(
      ...
      llmDiagnostico: json['llm_diagnostico'] as String? ?? '',
      llmTratamiento: json['llm_tratamiento'] as String? ?? '',
      llmPrevencion: json['llm_prevencion'] as String? ?? '',
